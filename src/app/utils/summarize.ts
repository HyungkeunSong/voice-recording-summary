...
const SYSTEM_PROMPT = `당신은 산업재해(산재) 사고 관련 통화 녹음을 분석하는 전문가입니다.
...

{
  ...
  "agreements": "각 항목을 bullet(•)으로 구분. 없으면 '확인된 사항 없음'",
  "legallySignificant": "각 항목을 bullet(•)으로 구분. 직접 인용은 「」로 감싸기.\\n예: • 수신자 측 진술: 「점검 완료 전까지 운행하면 안 된다」",
